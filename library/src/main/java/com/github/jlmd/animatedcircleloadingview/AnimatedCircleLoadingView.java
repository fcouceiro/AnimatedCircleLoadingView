...
public class AnimatedCircleLoadingView extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        checkMarkTintColor = attributes.getColor(R.styleable.AnimatedCircleLoadingView_checkMarkTintColor,
                Color.parseColor(DEFAULT_HEX_TINT_COLOR));
        failureMarkTintColor = attributes.getColor(R.styleable.AnimatedCircleLoadingView_failureMarkTintColor,
                Color.parseColor(DEFAULT_HEX_TINT_COLOR));
        attributes.recycle();
    }
